    ...
    <div className="bg-card rounded-lg shadow-md border overflow-hidden">
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between gap-2">
          <Button size={"sm"} className="flex-1 bg-primary text-primary-foreground hover:bg-primary/90 dark:text-white">View</Button> {/* Using global primary color */}
          <Button size={"sm"} variant="outline" className="flex-1 border-secondary text-secondary-foreground hover:bg-secondary/80"> {/* Using global secondary color */}
